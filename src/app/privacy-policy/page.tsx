...
<div className="min-h-screen bg-gray-100 flex flex-col items-center py-10 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl w-full bg-white shadow-md rounded-lg p-8">
        ...
        <div className="text-gray-700 leading-relaxed space-y-6">
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-800 mb-2">Sharing</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-800 mb-2">Security Precautions</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-800 mb-2">Data Deletion and Retention</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-800 mb-2">Consent</h2>
            <p>
