      ...
      <div className="max-w-4xl w-full bg-white shadow-md rounded-lg p-8">
        ...
        <div className="text-gray-700 leading-relaxed space-y-4">
          ...
          <p>
            ...
            thefoodcity.in (&apos;Website&apos;), including the related mobile
            site and mobile application (hereinafter referred to as
            &apos;Platform&apos;).
          </p>
          <p>
            The Platform is owned by THE FOOD CITY, a company incorporated under
            the Companies Act, 1956 with its registered office at Flat No A1,
            Ground Floor, Shyamlal Kunj Ranchi Circular Road, Ranchi, India
